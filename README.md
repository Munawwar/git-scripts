...
Syncs list of local branches with remote and merges the branches to a target branch. It does not rebase the branches, it just merges them. e.g.

```sh
# merge `branch1` and `branch2` into `release` branch
